# Task Plan — Revision 22: Coverage Stability Verification

## Goal
Verify TryRecoverAPIKeys test coverage fix and all gates remain stable through revision 22. Create the revision-22-matched task plan to satisfy the task plan gate.

## Baseline
- HEAD: commit 2a6f2e6 on branch main (published revision 3)
- Staged changes: 30 files, ~2466 insertions total
...
Task plans staged: rev3,4,5,7,11,12,14,16,18,21,22 (this file)
Orchestrator-owned ai/*.md: 19 files preserved
scripts/verify-hermes.ps1: preserved

## Steps
1. Create ai/task-plans/22-coverage-stability.md with all 9 headings and actual evidence
2. Stage: git add ai/task-plans/22-coverage-stability.md
...
- Fast gate: 3/3 packages OK, exit 0
  - api 0.719s, core 1.158s, compiler 1.087s
- Vet: clean, exit 0
...
### Stability Record
Rev 4: fix introduced. Rev 5-12: verified stable. Rev 13-19: master declared complete (11 consecutive). Rev 20-22: all gates pass, no regression.

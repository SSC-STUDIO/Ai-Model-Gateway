...
| 2026-05-30 | 2 | 0 | 0 | Added `site/codex-cli-gateway.html` / `https://ssc-studio.github.io/Ai-Model-Gateway/codex-cli-gateway.html` as a search and sharing landing page for Codex CLI, `openai_base_url`, OpenAI-compatible coding-agent traffic, fallback, telemetry, and rollback-safe config. |
...
| 2026-05-30 | 2 | 0 | 0 | Added `site/llm-gateway-adoption-checklist.html` / `https://ssc-studio.github.io/Ai-Model-Gateway/llm-gateway-adoption-checklist.html` as a shareable adoption checklist covering fit, install paths, client compatibility, provider fallback, config publish, rollback, quality evidence, and security. |

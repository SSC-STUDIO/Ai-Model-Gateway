...
func serializePayload(payload telemetryingest.EventPayload) (string, error) {
	data, err := json.Marshal(map[string]interface{}{
		...
		"pricing_status":              payload.PricingStatus,
		"pricing_source_id":           payload.PricingSourceID,
		"pricing_currency":            payload.PricingCurrency,
		"pricing_fx_rate_to_usd":      payload.PricingFXRateToUSD,
		"pricing_input_per_1m":        payload.PricingInputPer1M,
		"pricing_cached_input_per_1m": payload.PricingCachedInputPer1M,
		"pricing_output_per_1m":       payload.PricingOutputPer1M,
		"pricing_prompt_cost":         payload.PricingPromptCost,
		"pricing_completion_cost":     payload.PricingCompletionCost,
		"pricing_total_cost":          payload.PricingTotalCost,
		"pricing_prompt_cost_usd":     payload.PricingPromptCostUSD,
		"pricing_completion_cost_usd": payload.PricingCompletionCostUSD,
		"pricing_total_cost_usd":      payload.PricingTotalCostUSD,
		"synthetic_kind":              payload.SyntheticKind,
		"benchmark_run_id":            payload.BenchmarkRunID,
		"benchmark_target_id":         payload.BenchmarkTargetID,
		"benchmark_case_id":           payload.BenchmarkCaseID,
